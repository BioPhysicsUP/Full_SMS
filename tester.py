...
fit2 = TwoExp(irf, convd_noise, t, channelwidth, tau=[[4, 1, 15, 0], [0.1, 0.01, 4, 0]], startpoint=400, endpoint=2400, ploton=False)
fit = OneExp(irf, convd_noise, t, channelwidth, tau=[[4, 1, 15, 0]], startpoint=400, endpoint=2400, ploton=False)
