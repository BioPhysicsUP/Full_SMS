...
!define home_path "D:\OneDrive - University of Pretoria\# Code Dev\Full SMS"



!define setup "${home_path}\dist\Install Full SMS.exe"

; change this to wherever the files to be packaged reside
!define srcdir "${home_path}\dist\Full_SMS"
!define exec "Full_SMS.exe"

; icons must be Microsoft .ICO files
!define icon "Full-SMS.ico"  ; Inside src

!define company "UP Software"

!define prodname "Full SMS"

; optional stuff

; Set the text which prompts the user to enter the installation directory
DirText "This program allows the user to perform translation and axis-flipping transformations for coordinates in e57 files."
...
;!define files "File /r C:\e57_Transformation\dist\e57 Transformation\*"

; file containing list of file-uninstall commands
;!define unfiles "File /r C:\e57_Transformation\dist\e57 Transformation\*"
