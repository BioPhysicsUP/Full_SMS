...
class WorkerSignals(QObject):
    ...
    plot_convd_lock = pyqtSignal(int, object, bool, bool, object)
    ...
    plot_decay_convd_residuals_export = pyqtSignal(object, str, bool)
    plot_decay_convd_residuals_export_lock = pyqtSignal(object, str, bool, object)
