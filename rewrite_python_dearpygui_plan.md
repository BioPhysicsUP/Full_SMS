...
### Task 2.2: Create analysis result models `[TODO]`
...
### Task 3.2: Implement session save/load `[TODO]`
...
### Task 4.4: Port lifetime fitting - single exponential `[TODO]`
...
### Task 4.6: Port correlation analysis `[TODO]`
...
### Task 6.4: Create status bar and progress indicator `[TODO]`
